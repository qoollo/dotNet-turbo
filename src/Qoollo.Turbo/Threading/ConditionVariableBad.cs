...
namespace Qoollo.Turbo.Threading
{
    ...
    /// </summary>
    internal class ConditionVariableBad: IDisposable
    {
        /// <summary>
        ...
        {
            ConditionVariableBad conditionVar = obj as ConditionVariableBad;
        ...
        internal ConditionVariableBad(object externalSyncObject)
        {
