    ...
    internal class SparceArrayStorage<T> where T: class
    {
        ...
        public int Add(T element)
        {
            ...
            lock (_syncObj)
            {
                ...
                TurboContract.Assert(index >= 0, "index >= 0");
                TurboContract.Assert(index < data.Length, "index < data.Length");
                TurboContract.Assert(data[index] == null, "data[index] == null");
        ...
        {
            TurboContract.Requires(index >= 0, "index >= 0");
            TurboContract.Requires(index < _data.Length, "index < _data.Length");
        ...
        private void CompactWithElementMovingCore()
        {
            ...
            TurboContract.Assert(newSize < data.Length, "newSize < data.Length");
