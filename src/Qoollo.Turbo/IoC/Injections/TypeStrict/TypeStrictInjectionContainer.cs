...
namespace Qoollo.Turbo.IoC.Injections
{
    ...
    /// Suitable for concurrent access. Uses ConcurrentDictionary under cover.
    /// </summary>
    public class TypeStrictInjectionContainer : ConcurrentGenericInjectionContainer<Type>, IInjectionResolver
    {
        /// <summary>
        /// TypeStrictInjectionContainer constructor
        /// </summary>
