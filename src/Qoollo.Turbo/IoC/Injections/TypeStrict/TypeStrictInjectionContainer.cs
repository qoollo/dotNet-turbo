...
namespace Qoollo.Turbo.IoC.Injections
{
    ...
    /// </summary>
    public sealed class TypeStrictInjectionContainer : ConcurrentGenericInjectionContainer<Type>
    {
        ...
        {
            private readonly TypeStrictInjectionContainer _container;
            ...
            internal TypeStrictDirectInjectionResolver(TypeStrictInjectionContainer container)
            {
        ...
        public TypeStrictInjectionContainer(bool disposeInjectionsWithBuilder)
        ...
        /// Конструктор TypeStrictInjectionContainer
        /// </summary>
        public TypeStrictInjectionContainer()
        {
            _fastDirectResolver = new TypeStrictDirectInjectionResolver(this);
        }
