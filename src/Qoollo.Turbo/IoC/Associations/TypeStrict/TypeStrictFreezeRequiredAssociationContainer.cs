...
namespace Qoollo.Turbo.IoC.Associations
{
    ...
    /// </summary>
    public abstract class TypeStrictFreezeRequiredAssociationContainer : FreezeRequiredGenericAssociationContainer<Type>,
        ...
        IDirectSingletonAssociationSupport<Type>, ICustomAssociationSupport<Type>
    {
        ...
        {
            base.AddAssociation(key, new Qoollo.Turbo.IoC.Lifetime.SingletonLifetime(val));
        }
        ...
        public void AddSingleton(Type key, object val, bool disposeWithContainer)
        {
            ...
            base.AddAssociation(key, new Qoollo.Turbo.IoC.Lifetime.SingletonLifetime(val, disposeWithContainer));
        }
        ...
        {
            return base.TryAddAssociation(key, new Qoollo.Turbo.IoC.Lifetime.SingletonLifetime(val));
        }
        ...
        public bool TryAddSingleton(Type key, object val, bool disposeWithContainer)
        {
            ...
            return base.TryAddAssociation(key, new Qoollo.Turbo.IoC.Lifetime.SingletonLifetime(val, disposeWithContainer));
        }
